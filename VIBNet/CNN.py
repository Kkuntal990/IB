...
def LSTM(dr, classes):
    ...
    layer11 = tf.keras.layers.Conv2D(50, (1, 8), padding='valid', activation="relu", name="conv11", init='glorot_uniform',
    ...
    layer12 = tf.keras.layers.Conv2D(50, (1, 8), padding="valid", activation="relu", name="conv12", init='glorot_uniform',
    ...
    layer13 = tf.keras.layers.Conv2D(50, (1, 8), padding='valid', activation="relu", name="conv13", init='glorot_uniform',
    ...
    layer_dense2 = tf.keras.layers.Dense(len(classes), init='he_normal',
